...
namespace Org.OpenAPITools.Model
{
    ...
    public partial class InlineObject4 :  IEquatable<InlineObject4>, IValidatableObject
    {
        ...
        /// Initializes a new instance of the <see cref="InlineObject4" /> class.
        /// </summary>
        /// <param name="phone">国内手机号 (required).</param>
        /// <param name="code">code (required).</param>
        /// <param name="robotcode">robotcode (required).</param>
        /// <param name="robotcodeid">robotcodeid (required).</param>
        public InlineObject4(string phone = default(string), string code = default(string), string robotcode = default(string), string robotcodeid = default(string))
        {
            // to ensure "phone" is required (not null)
            if (phone == null)
            {
                throw new InvalidDataException("phone is a required property for InlineObject4 and cannot be null");
            }
            else
            {
                this.Phone = phone;
            ...
            if (code == null)
            {
                throw new InvalidDataException("code is a required property for InlineObject4 and cannot be null");
            }
            else
            {
                this.Code = code;
            ...
            if (robotcode == null)
            {
                throw new InvalidDataException("robotcode is a required property for InlineObject4 and cannot be null");
            }
            else
            {
            ...
            if (robotcodeid == null)
            {
                throw new InvalidDataException("robotcodeid is a required property for InlineObject4 and cannot be null");
            }
            else
            {
